...
Unit tests framework to run all tests associated with backend. To run additional tests, file must be pre-pended with
...
class UnitTestLauncher(object):
    """
    A class to run all unittests within the tests framework.
    """
